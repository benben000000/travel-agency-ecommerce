...
export default function UserProfilePage() {
  ...
  const [form, setForm] = useState({ name: '', email: '', phone: '', bio: '', currentPassword: '', newPassword: '' });
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setStatus({ loading: false, success: '', error: 'Failed to update profile.' });
    }
  }
    ...
    <div style={{ maxWidth: '640px' }}>
      ...
      <div className="card" style={{ padding: '32px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label className="form-label">Bio / Traveler Notes</label>
            <textarea
              rows={3}
              className="form-textarea"
              value={form.bio}
              onChange={(e) => setForm({ ...form, bio: e.target.value })}
              placeholder="Tell tour operators a little about your travel preferences..."
            />
          </div>
